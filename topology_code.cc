...
//cmd lines
 ...
 //Link Capacity Setting by 
    PointToPointHelper pt0p1;
    pt0p1.SetDeviceAttribute("DataRate", StringValue("100Mbps"));
    pt0p1.SetChannelAttribute("Delay", StringValue("0.5ms"));
    NetDeviceContainer d0d4 = pt0p1.Install(n0n4); 
    NetDeviceContainer d1d3 = pt0p1.Install(n1n3); 
    NetDeviceContainer d2d3 = pt0p1.Install(n2n3); 
    NetDeviceContainer d3d4 = pt0p1.Install(n3n4); 
...
//flow setting  
  ...
  AnimationInterface anim ("1001965572_navya.xml");   
